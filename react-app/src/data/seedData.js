export const SEED_DATA = {
  bnp:{
    ...
    stakeholders:[
      {init:'LP',bg:'#e8f0fb',tc:'#0056b3',name:'Laurence Pessez',role:'Global Head of CSR · BNP Paribas',why:'Owns net-zero strategy, CSRD Wave 1 reporting and ESG KPI governance across the Group',priority:'Priority 1',emailFocus:'sustainability',ph:true},
      {init:'BG',bg:'#fff3e8',tc:'#e06800',name:'Bernard Gavgani',role:'Group Chief Information Officer · BNP Paribas',why:'Oversees all Group IT infrastructure, digital transformation and technology carbon footprint',priority:'Priority 1',emailFocus:'technology',ph:true},
      {init:'JB',bg:'#f3f0fb',tc:'#5c35cc',name:'Jean-Laurent Bonnafé',role:'Chief Executive Officer · BNP Paribas',why:'Final decision-maker on net-zero financing commitments and ESG integration into Group strategy',priority:'Priority 2',emailFocus:'executive',ph:true}
    ],
    questions:[
  ...
  unilever:{
    ...
    stakeholders:[
      ...
      {init:'FF',bg:'#f3f0fb',tc:'#5c35cc',name:'Fernando Fernandez',role:'Chief Executive Officer · Unilever',why:'CEO since March 2025, accountable for Climate Transition Action Plan and net-zero 2039 delivery',priority:'Priority 1',emailFocus:'executive',ph:true},
      {init:'JE',bg:'#fff3e8',tc:'#e06800',name:'Juergen Esser',role:'Chief Financial & Technology Officer · Unilever',why:'Combined CFO/CTO role responsible for ESG data infrastructure and CSRD financial disclosure',priority:'Priority 2',emailFocus:'technology',ph:true}
    ],
    questions:[
  ...
  renault:{
    ...
    stakeholders:[
      ...
      {init:'PB',bg:'#fff3e8',tc:'#e06800',name:'Philippe Brunet',role:'Chief Technology Officer · Renault Group',why:'CTO since September 2025, leads EV engineering, electrification and digital manufacturing transformation',priority:'Priority 1',emailFocus:'technology',ph:true},
      {init:'FP',bg:'#f3f0fb',tc:'#5c35cc',name:'François Provost',role:'Chief Executive Officer · Renault Group',why:'CEO since July 2025, leading accelerated transformation toward electrification and sustainability',priority:'Priority 2',emailFocus:'executive',ph:true}
    ],
    questions:[
  ...
  lvmh:{
    ...
    stakeholders:[
      ...
      {init:'AA',bg:'#f3f0fb',tc:'#5c35cc',name:'Antoine Arnault',role:'Director of Image & Environment · LVMH',why:'Executive Committee sponsor of all environmental initiatives, reports directly to Bernard Arnault',priority:'Priority 1',emailFocus:'executive',ph:true},
      {init:'CC',bg:'#fff3e8',tc:'#e06800',name:'Cécile Cabanis',role:'Chief Financial Officer · LVMH',why:'CFO since February 2025, responsible for CSRD financial disclosure and ESG capital allocation',priority:'Priority 2',emailFocus:'technology',ph:true}
    ],
    questions:[
  ...
  schneider:{
    ...
    stakeholders:[
      ...
      {init:'OB',bg:'#f3f0fb',tc:'#5c35cc',name:'Olivier Blum',role:'Chief Executive Officer · Schneider Electric',why:'CEO since November 2024, accelerating sustainability and AI-driven energy management strategy',priority:'Priority 1',emailFocus:'executive',ph:true},
      {init:'KH',bg:'#fff3e8',tc:'#e06800',name:'Karoline Herth',role:'Chief Digital Officer · Schneider Electric',why:'Leads digital infrastructure, eco-design compliance and RGESN framework implementation',priority:'Priority 2',emailFocus:'technology',ph:true}
    ],
    questions:[
  ...
  total:{
    ...
    stakeholders:[
      {init:'AH',bg:'#edf7f1',tc:'#1a7a4a',name:'Aurélien Hamelle',role:'President, Strategy & Sustainability · TotalEnergies',why:'Executive Committee member responsible for climate strategy and sustainability since January 2024',priority:'Priority 1',emailFocus:'sustainability',ph:true},
      {init:'PP',bg:'#f3f0fb',tc:'#5c35cc',name:'Patrick Pouyanné',role:'Chairman & CEO · TotalEnergies',why:'Personally drives the multi-energy company strategy and public net-zero narrative',priority:'Priority 1',emailFocus:'executive',ph:true},
      {init:'JS',bg:'#fff3e8',tc:'#e06800',name:'Jean-Pierre Sbraire',role:'Chief Financial Officer · TotalEnergies',why:'CFO responsible for CSRD financial reporting and capital allocation toward low-carbon investments',priority:'Priority 2',emailFocus:'technology',ph:true}
    ],
    questions:[
  ...
  axa:{
    ...
    stakeholders:[
      {init:'TB',bg:'#f3f0fb',tc:'#5c35cc',name:'Thomas Buberl',role:'Chief Executive Officer · AXA',why:'Personally committed to net-zero underwriting by 2050 and leading climate systemic risk agenda',priority:'Priority 1',emailFocus:'executive',ph:true},
      {init:'AM',bg:'#edf7f1',tc:'#1a7a4a',name:'Alban de Mailly Nesle',role:'Group Chief Risk Officer · AXA',why:'Oversees climate risk integration into underwriting, investment and ESG portfolio alignment',priority:'Priority 1',emailFocus:'sustainability',ph:true},
      {init:'FD',bg:'#fff3e8',tc:'#e06800',name:'Frédéric de Courtois',role:'Deputy CEO · AXA',why:'Deputy CEO overseeing Group transformation including digital infrastructure and ESG data systems',priority:'Priority 2',emailFocus:'technology',ph:true}
    ],
    questions:[
  ...
  danone:{
    ...
    stakeholders:[
      ...
      {init:'AS',bg:'#f3f0fb',tc:'#5c35cc',name:'Antoine de Saint-Affrique',role:'Chief Executive Officer · Danone',why:'CEO driving sustainability as core business strategy and B Corp commitment across all markets',priority:'Priority 1',emailFocus:'executive',ph:true},
      {init:'JE',bg:'#fff3e8',tc:'#e06800',name:'Juergen Esser',role:'Chief Financial & Technology Officer · Danone',why:'Combined CFO/CTO role responsible for ESG data infrastructure and CSRD financial disclosure',priority:'Priority 2',emailFocus:'technology',ph:true}
    ],
    questions:[
  ...
  airbus:{
    ...
    stakeholders:[
      {init:'JK',bg:'#edf7f1',tc:'#1a7a4a',name:'Julie Kitcher',role:'EVP Communications & Corporate Affairs · Airbus',why:'Oversees sustainability strategy, net-zero 2050 roadmap and hydrogen aircraft programme',priority:'Priority 1',emailFocus:'sustainability',ph:true},
      {init:'GF',bg:'#f3f0fb',tc:'#5c35cc',name:'Guillaume Faury',role:'Chief Executive Officer · Airbus',why:'Personally committed to zero-emission commercial aircraft by 2035 and aviation decarbonisation',priority:'Priority 1',emailFocus:'executive',ph:true},
      {init:'SK',bg:'#fff3e8',tc:'#e06800',name:'Sabine Klauke',role:'Chief Technology Officer · Airbus',why:'CTO leading hydrogen propulsion, sustainable aviation fuel and zero-emission aircraft development',priority:'Priority 2',emailFocus:'technology',ph:true}
    ],
    questions:[
