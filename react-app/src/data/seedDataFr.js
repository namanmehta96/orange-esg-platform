export const SEED_DATA_FR = {
  bnp:{
    ...
    stakeholders:[
      {init:'LP',bg:'#e8f0fb',tc:'#0056b3',name:'Laurence Pessez',role:'Responsable Mondiale RSE · BNP Paribas',why:'Pilote la stratégie net zéro, le reporting CSRD Vague 1 et la gouvernance des KPI ESG pour l\'ensemble du Groupe',priority:'Priorité 1',emailFocus:'sustainability',ph:true},
      {init:'BG',bg:'#fff3e8',tc:'#e06800',name:'Bernard Gavgani',role:'Directeur des Systèmes d\'Information Groupe · BNP Paribas',why:'Supervise l\'ensemble de l\'infrastructure IT Groupe, la transformation digitale et l\'empreinte carbone technologique',priority:'Priorité 1',emailFocus:'technology',ph:true},
      {init:'JB',bg:'#f3f0fb',tc:'#5c35cc',name:'Jean-Laurent Bonnafé',role:'Directeur Général · BNP Paribas',why:'Décideur final sur les engagements de financement net zéro et l\'intégration ESG dans la stratégie Groupe',priority:'Priorité 2',emailFocus:'executive',ph:true}
    ],
    questions:[
  ...
  unilever:{
    ...
    leaderQuotes:[
      ...
      {name:'Rebecca Marmot',title:'Directrice Développement Durable, Unilever',quote:'Notre Plan d\'Action pour la Transition Climatique nous permet de comprendre où se situent nos émissions dans notre activité et notre chaîne de valeur.',source:'Unilever Climate Transition Action Plan 2024, https://www.unilever.com/files/8b5df5f6-cb90-40fd-9691-38d06905d81d/unilever-climate-transition-action-plan-updated-2024.pdf',orangeOpportunity:'ESG Data Platform Supplier Portal, le suivi en temps réel des émissions fournisseurs est la pièce manquante entre l\'ambition et un suivi vérifié du CTAP.'}
    ],
    esg:[
    ...
    stakeholders:[
      ...
      {init:'FF',bg:'#f3f0fb',tc:'#5c35cc',name:'Fernando Fernandez',role:'Directeur Général · Unilever',why:'Directeur Général depuis mars 2025, responsable de l\'exécution du Plan de Transition Climatique et de l\'atteinte du net zéro en 2039',priority:'Priorité 1',emailFocus:'executive',ph:true},
      {init:'JE',bg:'#fff3e8',tc:'#e06800',name:'Juergen Esser',role:'Directeur Financier et Technologique · Unilever',why:'Double rôle CFO/CTO responsable de l\'infrastructure de données ESG et du reporting financier CSRD',priority:'Priorité 2',emailFocus:'technology',ph:true}
    ],
    questions:[
  ...
  renault:{
    ...
    stakeholders:[
      ...
      {init:'PB',bg:'#fff3e8',tc:'#e06800',name:'Philippe Brunet',role:'Directeur Technique · Renault Group',why:'CTO depuis septembre 2025, pilote l\'ingénierie VE, l\'électrification et la transformation manufacturière digitale',priority:'Priorité 1',emailFocus:'technology',ph:true},
      {init:'FP',bg:'#f3f0fb',tc:'#5c35cc',name:'François Provost',role:'Directeur Général · Renault Group',why:'Directeur Général depuis juillet 2025, pilote une transformation accélérée vers l\'électrification et la durabilité',priority:'Priorité 2',emailFocus:'executive',ph:true}
    ],
    questions:[
  ...
  lvmh:{
    ...
    leaderQuotes:[
      {name:'Bernard Arnault',title:'Président-Directeur Général, LVMH',quote:'LIFE 360 est la feuille de route de LVMH pour l\'avenir, un programme complet qui reflète notre engagement à rendre luxe et développement durable indissociables.',source:'LVMH LIFE 360 Programme, https://www.lvmh.com/en/commitment-in-action/for-the-environment',orangeOpportunity:'ESG Data Management Platform, LVMH doit agréger les données de développement durable LIFE 360 de 75 Maisons pour la déclaration CSRD Vague 1.'},
      {name:'Marie-Claire Daveu',title:'Directrice Développement Durable, LVMH',quote:'La traçabilité n\'est pas optionnelle pour le luxe, nos clients et les régulateurs exigent de connaître l\'origine de chaque matière que nous utilisons.',source:'LVMH Sustainability Report 2024, https://www.lvmh.com/en/investors/esg',orangeOpportunity:'Frugal AI for Supply Chain Traceability, des modèles d\'IA légers peuvent automatiser la vérification ESG des fournisseurs dans la chaîne d\'approvisionnement multi-niveaux complexe de LVMH.'}
    ],
    esg:[
    ...
    stakeholders:[
      ...
      {init:'AA',bg:'#f3f0fb',tc:'#5c35cc',name:'Antoine Arnault',role:'Directeur Image & Environnement · LVMH',why:'Sponsor au Comité Exécutif de toutes les initiatives environnementales, rattaché directement à Bernard Arnault',priority:'Priorité 1',emailFocus:'executive',ph:true},
      {init:'CC',bg:'#fff3e8',tc:'#e06800',name:'Cécile Cabanis',role:'Directrice Financière · LVMH',why:'Directrice Financière depuis février 2025, responsable du reporting financier CSRD et de l\'allocation de capital ESG',priority:'Priorité 2',emailFocus:'technology',ph:true}
    ],
    questions:[
  ...
  schneider:{
    ...
    stakeholders:[
      ...
      {init:'OB',bg:'#f3f0fb',tc:'#5c35cc',name:'Olivier Blum',role:'Directeur Général · Schneider Electric',why:'Directeur Général depuis novembre 2024, accélère la stratégie de développement durable et de gestion énergétique pilotée par l\'IA',priority:'Priorité 1',emailFocus:'executive',ph:true},
      {init:'KH',bg:'#fff3e8',tc:'#e06800',name:'Karoline Herth',role:'Directrice Digital · Schneider Electric',why:'Pilote l\'infrastructure digitale, la conformité éco-conception et la mise en œuvre du référentiel RGESN',priority:'Priorité 2',emailFocus:'technology',ph:true}
    ],
    questions:[
  ...
  total:{
    ...
    stakeholders:[
      {init:'AH',bg:'#edf7f1',tc:'#1a7a4a',name:'Aurélien Hamelle',role:'Président, Stratégie & Développement Durable · TotalEnergies',why:'Membre du Comité Exécutif responsable de la stratégie climatique et du développement durable depuis janvier 2024',priority:'Priorité 1',emailFocus:'sustainability',ph:true},
      {init:'PP',bg:'#f3f0fb',tc:'#5c35cc',name:'Patrick Pouyanné',role:'Président-Directeur Général · TotalEnergies',why:'Pilote personnellement la stratégie multi-énergies et le récit public net zéro du groupe',priority:'Priorité 1',emailFocus:'executive',ph:true},
      {init:'JS',bg:'#fff3e8',tc:'#e06800',name:'Jean-Pierre Sbraire',role:'Directeur Financier · TotalEnergies',why:'Directeur Financier responsable du reporting financier CSRD et de l\'allocation du capital vers les investissements bas-carbone',priority:'Priorité 2',emailFocus:'technology',ph:true}
    ],
    questions:[
  ...
  axa:{
    ...
    leaderQuotes:[
      {name:'Thomas Buberl',title:'CEO, AXA',quote:'Le changement climatique est le risque systémique le plus important auquel nous faisons face en tant qu\'assureur et investisseur. Le rôle d\'AXA est d\'accélérer la transition, pas seulement de gérer le risque.',source:'AXA 2024 Climate and Biodiversity Report, https://www-axa-com.cdn.axa-contento-118412.eu/www-axa-com/8b8dfa69-13e3-4c34-bae3-8fb939102a2d_axa_climate_and_biodiversity_report_2024_va.pdf',orangeOpportunity:'Scope 3 Carbon Estimator, les émissions du portefeuille d\'investissement d\'AXA nécessitent un suivi carbone granulaire au niveau des actifs pour soutenir ses engagements net zéro en souscription.'},
      {name:'AXA Group',title:'Engagement corporate',quote:'AXA s\'est engagé à aligner son portefeuille d\'investissement sur une trajectoire 1,5°C et à sortir de la souscription charbon d\'ici 2030 dans les pays de l\'OCDE.',source:'AXA Climate & Biodiversity Report 2024, https://www-axa-com.cdn.axa-contento-118412.eu/www-axa-com/8b8dfa69-13e3-4c34-bae3-8fb939102a2d_axa_climate_and_biodiversity_report_2024_va.pdf',orangeOpportunity:'ESG Data Platform, gérer et reporter l\'alignement climatique sur le portefeuille d\'investissement de plusieurs milliers de milliards d\'euros d\'AXA nécessite une infrastructure de données ESG d\'envergure entreprise.'}
    ],
    esg:[
    ...
    stakeholders:[
      {init:'TB',bg:'#f3f0fb',tc:'#5c35cc',name:'Thomas Buberl',role:'Directeur Général · AXA',why:'Engagé personnellement sur la souscription net zéro en 2050 et pilote l\'agenda risque climatique systémique',priority:'Priorité 1',emailFocus:'executive',ph:true},
      {init:'AM',bg:'#edf7f1',tc:'#1a7a4a',name:'Alban de Mailly Nesle',role:'Directeur des Risques Groupe · AXA',why:'Supervise l\'intégration du risque climatique dans la souscription, l\'investissement et l\'alignement ESG du portefeuille',priority:'Priorité 1',emailFocus:'sustainability',ph:true},
      {init:'FD',bg:'#fff3e8',tc:'#e06800',name:'Frédéric de Courtois',role:'Directeur Général Adjoint · AXA',why:'Directeur Général Adjoint en charge de la transformation Groupe, incluant l\'infrastructure digitale et les systèmes de données ESG',priority:'Priorité 2',emailFocus:'technology',ph:true}
    ],
    questions:[
  ...
  danone:{
    ...
    leaderQuotes:[
      {name:'Antoine de Saint-Affrique',title:'CEO, Danone',quote:'Danone a été fondée sur l\'idée que le succès économique et le progrès social ne sont pas seulement compatibles, ils sont indissociables. Nous renforçons cette conviction.',source:'Danone Annual Integrated Report 2024, https://www.danone.com/content/dam/corp/global/danonecom/investors/en-sustainability/reports-and-data/cross-topic/danoneiar2024.pdf',orangeOpportunity:'ESG Data Collection Platform, la certification B Corp de Danone sur l\'ensemble de son portefeuille exige une collecte continue de données ESG sur tous les marchés et gammes de produits.'},
      {name:'Danone',title:'Engagement corporate',quote:'Nous nous engageons à devenir entièrement neutre en carbone sur l\'ensemble de notre chaîne de valeur d\'ici 2050, avec une réduction absolue de 30 % des émissions d\'ici 2030.',source:'Danone Sustainability, https://www.danone.com/sustainability.html',orangeOpportunity:'Scope 3 Supplier Carbon Estimator, la filière laitière de Danone représente plus de 60 % de son empreinte Scope 3 et nécessite un suivi automatisé des émissions fournisseurs.'}
    ],
    esg:[
    ...
    stakeholders:[
      ...
      {init:'AS',bg:'#f3f0fb',tc:'#5c35cc',name:'Antoine de Saint-Affrique',role:'Directeur Général · Danone',why:'Directeur Général qui fait du développement durable le cœur de la stratégie et porte l\'engagement B Corp sur tous les marchés',priority:'Priorité 1',emailFocus:'executive',ph:true},
      {init:'JE',bg:'#fff3e8',tc:'#e06800',name:'Juergen Esser',role:'Directeur Financier et Technologique · Danone',why:'Double rôle CFO/CTO responsable de l\'infrastructure de données ESG et du reporting financier CSRD',priority:'Priorité 2',emailFocus:'technology',ph:true}
    ],
    questions:[
  ...
  airbus:{
    ...
    stakeholders:[
      {init:'JK',bg:'#edf7f1',tc:'#1a7a4a',name:'Julie Kitcher',role:'EVP Communications & Affaires Corporate · Airbus',why:'Supervise la stratégie développement durable, la feuille de route net zéro 2050 et le programme avion hydrogène',priority:'Priorité 1',emailFocus:'sustainability',ph:true},
      {init:'GF',bg:'#f3f0fb',tc:'#5c35cc',name:'Guillaume Faury',role:'Directeur Général · Airbus',why:'Engagé personnellement sur l\'avion commercial zéro émission en 2035 et la décarbonation de l\'aviation',priority:'Priorité 1',emailFocus:'executive',ph:true},
      {init:'SK',bg:'#fff3e8',tc:'#e06800',name:'Sabine Klauke',role:'Directrice Technique · Airbus',why:'CTO qui pilote la propulsion hydrogène, les carburants d\'aviation durables et le développement de l\'avion zéro émission',priority:'Priorité 2',emailFocus:'technology',ph:true}
    ],
    questions:[
